(function ($, elementor) {
    ...
    var widgetMount = function ($scope, $) {
        ...
        $($mountSlider).find('.bdt-slideshow-item').each(function (i, e) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/prime-slider-mount.default', widgetMount);
    });
