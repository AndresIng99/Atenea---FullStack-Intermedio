(function ($, elementor) {
    ...
    var widgetSequester = function ($scope, $) {
        ...
        $($sequesterSlider).find('.bdt-slideshow-item').each(function (i, e) {
    ...
    jQuery(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/prime-slider-sequester.default', widgetSequester);
    });
